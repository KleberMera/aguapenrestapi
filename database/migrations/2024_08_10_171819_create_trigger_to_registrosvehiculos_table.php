...
return new class extends Migration
{
    ...
    {
        DB::unprepared('
        CREATE TRIGGER actualizar_stock_v AFTER UPDATE ON registro_vehiculos
        FOR EACH ROW
        BEGIN
            ...
            FROM registro_detalle_vehiculos
            WHERE id_registro_vehiculo = NEW.id;
    ...
    {
        DB::unprepared('DROP TRIGGER IF EXISTS actualizar_stock_v;');
    }
};
